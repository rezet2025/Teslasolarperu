      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "120px 24px 80px", position: "relative", zIndex: 2, width: "100%" }}>
        ...
        <FadeIn delay={0.5}>
          <div style={{
            ...
            {[
              { num: "500+", label: "Instalaciones", color: COLORS.sun },
              { num: "10+", label: "Años de experiencia", color: COLORS.sky },
              ...
              <div key={i} style={{ padding: "28px 20px", textAlign: "center", background: "rgba(255,255,255,0.02)" }}>
                <div style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 800, fontSize: 32, color: s.color }}>{s.num}</div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", color: "rgba(255,255,255,0.5)", fontSize: 14, marginTop: 4 }}>{s.label}</div>
              </div>
            ))}
          </div>
        </FadeIn>
...
function Kits() {
  const kits = [
    { name: "Kit Básico", power: "3 kWp", panels: "6 Paneles 550W", inverter: "Inversor 3kW", price: "Desde $2,800", features: ["Ideal para casas pequeñas", "Ahorro del 70%", "Garantía 10 años"], popular: false },
    { name: "Kit Hogar Plus", power: "5 kWp", panels: "10 Paneles 550W", inverter: "Inversor 5kW", price: "Desde $4,500", features: ["Para consumo medio-alto", "Ahorro del 90%", "Garantía 15 años"], popular: true },
    { name: "Kit Empresarial", power: "10 kWp", panels: "20 Paneles 550W", inverter: "Inversor 10kW", price: "Desde $8,200", features: ["Comercios y oficinas", "Ahorro del 95%", "Garantía 25 años"], popular: false },
  ];
  return (
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2 }}>
        <FadeIn>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="https://wa.me/TUNUMERO" target="_blank" style={{
    ...
    <div style={{ overflowX: "hidden" }}>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes panelGlow {
          0%, 100% { opacity: 0.6; }
          50% { opacity: 1; box-shadow: inset 0 0 12px rgba(20,184,166,0.3); }
        }
        @keyframes pulse {
